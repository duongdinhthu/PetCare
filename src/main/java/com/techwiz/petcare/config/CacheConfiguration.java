package com.techwiz.petcare.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.techwiz.petcare.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.techwiz.petcare.repository.UserRepository.USERS_BY_EMAIL_CACHE);
